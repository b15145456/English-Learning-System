...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-4">
	<form id="form_word"  method="post" onsubmit="return check();"  action="judge_split_test_gene.php">
    <p id="voc"><?php echo $_SESSION["gene_voc"];?></p>
		<input type=text id="answer" name="answer">
		
	<br>	
    <br>
	<audio controls autoplay>
	<source src="/MEDIA/<?php echo $_SESSION["gene_voc"];?>.mp3" type="audio/mpeg" autostart="ture">
	</audio>
    <br>
    <br>
		
		&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp題目  <?php echo $_SESSION["quest_gene"];?>/<?php echo $_SESSION["gene_size"]; ?>
