	  ...
	  <div class="row" width="300" border="1">
		...
		<div class="col-lg-4">
		  <table>
			...
			<tr>
			<td><?php echo $i+1; ?></td><td><?php echo $_SESSION["u_answer"][$i]; ?></td><td> <?php echo $_SESSION["all_voc_classic"][$i];?> </td>
			</tr>
			<?php } ?>
			</table>
			<br><br><br>
		...
		<div class="col-sm-4">
		  ...
		  <div class="row">
			...
			<button class="a" type="button" onclick="location.href='main.php'">回首頁</button>
			 <button class="a" type="button" onclick="location.href='classical_select.php'">重新測驗</button>
			<br><br>
			</div>
			<div class="col-sm-4">
			</div>
