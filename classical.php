...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-4">
	<form id="form_word"  method="post" onsubmit="return check();"  action="judge_split_test_classic.php">
    <p id="voc"><?php echo $_SESSION["voc_classic"];?></p>
		<input type=text id="answer" name="answer">
		
	<br>	
    <br>
	<audio controls autoplay>
	<source src="/MEDIA/<?php echo $_SESSION["voc_classic"];?>.mp3" type="audio/mpeg" autostart="false">
	</audio>
    <br>
    <br>
		&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp題目  <?php echo $_SESSION["quest_class"];?>/<?php echo $_SESSION["number_select"];?>
